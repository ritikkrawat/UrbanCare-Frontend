          ...
          <button
            ...
            onClick={() => {
              ...
              if (item.key === "password") {
                navigate("/changePassword"); // ✅ added properly
              }
            }}
...
const ChangePasswordContent = ({ onBack }) => {
  const navigate = useNavigate();
  ...
  return (
    <main className="cp-main">
      ...
      <div className="cp-form-card">
        ...
        {error && (
          <p style={{ color: "#c0392b", fontSize: 13, marginBottom: 16, fontWeight: 500 }}>
            {error}
          </p>
        )}
  ...
  return (
    <>
      ...
      <div className="cp-wrapper">
        ...
        <ChangePasswordContent onBack={() => window.history.back()} />
      </div>
